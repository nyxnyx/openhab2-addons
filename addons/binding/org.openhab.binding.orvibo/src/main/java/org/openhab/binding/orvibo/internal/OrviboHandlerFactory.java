...
import static org.openhab.binding.orvibo.OrviboBindingConstants.THING_TYPE_ALLONE;
 ...
 * @author Grzegorz Szostak  - Adding AllOne
 */
public class OrviboHandlerFactory extends BaseThingHandlerFactory {
    ...
    private static final Set<ThingTypeUID> SUPPORTED_THING_TYPES_UIDS =
            new HashSet<>(Arrays.asList(THING_TYPE_S20, THING_TYPE_ALLONE));
